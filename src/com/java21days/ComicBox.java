...
public class ComicBox {
    ...
    public ComicBox(){
        ...
        comix[0] = new InnerComic("Amazing Spider-Man", "1A", "very fine",5_000.00F);
        comix[0].setPrice( (Float) quality.get(comix[0].condition) );
        comix[1] = new InnerComic("Incredible Hulk", "181","near mint" ,240.00F);
        comix[1].setPrice( (Float) quality.get(comix[1].condition) );
        comix[2] = new InnerComic("Cerebus", "1A", "good", 144.00F);
