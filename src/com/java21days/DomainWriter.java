...
public class DomainWriter {
    public static void main(String[] args) throws IOException {
        try {
            // Create a tree for an XML document
            ...
            // Add the comment abouve everything else in the document
            doc.insertChild(timestamp, 0);

            // Create a file output stream to a new file
            FileOutputStream f = new FileOutputStream("feed3.rss");

            // Using a serializer with indention set to 2 spaces, write the XML document to the file
